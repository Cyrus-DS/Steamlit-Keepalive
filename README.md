...
This finance application ([Open Finance App](https://ndundu-finance-appgit-5xrzkytijl5kizazc5uxav.streamlit.app/#generate-statements)) is built using Streamlit and hosted on Streamlit Community Cloud.
